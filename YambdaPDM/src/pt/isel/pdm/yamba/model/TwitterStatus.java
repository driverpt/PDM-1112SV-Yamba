...
public class TwitterStatus extends TreeMap< String, Object > {
    ...
    public TwitterStatus( long id, String user, Date date, String tweet, URI photoUri, int friendsCount, int followersCount, int postsCount) {
        putData(id, user, date, tweet, photoUri,friendsCount, followersCount, postsCount);
    }

    private void putData(long id, String user, Date date, String tweet, URI pictureUri, int friendsCount, int followersCount, int postsCount) {
        put( KEY_ID, id );
        put( KEY_DATE, date );
        put( KEY_USER, user );
        put( KEY_TWEET, tweet );
