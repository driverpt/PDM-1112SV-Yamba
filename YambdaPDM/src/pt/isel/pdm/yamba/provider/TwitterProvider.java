...
public class TwitterProvider extends ContentProvider {
    ...
    private static final int        USER_ALL          = 4;
    private static final int        USER_ID           = 8;
    private static final int        TWEET_TO_POST_ALL = 16;
    private static final int        TWEET_TO_POST_ID  = 32;
    ...
    public boolean onCreate() {
        Log.d( "PDM", "TwitterProvider: onCreate()" );
    ...
    private SelectionParameters makeSelection( Uri uri, String sel ) {
        ...
        switch ( matchResult ) {
            ...
            case TWEET_TO_POST_ID:
                return new SelectionParameters( TweetPostContract.TABLE, TweetPostContract._ID + "="
